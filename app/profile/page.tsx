        ...
        <div className="relative h-48 rounded-xl overflow-hidden">
          ...
          <div className="absolute bottom-6 left-6 text-white">
            ...
            <p className="text-sm opacity-90">
              Join us in making a difference through food sharing
            </p>
          </div>
        </div>
