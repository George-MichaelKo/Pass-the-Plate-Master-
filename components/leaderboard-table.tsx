            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <Badge
                    variant="secondary"
                    className="flex items-center gap-1 shrink-0 bg-green-100 text-green-800 hover:bg-green-200"
                  >
                ...
                <div className="flex items-center gap-3 text-sm text-green-600 flex-wrap mt-1">
                  <span className="shrink-0 flex items-center gap-1">
                    <span className="font-medium">{donor.donations}</span>{" "}
                    donations
                  </span>
                  <span className="shrink-0 text-green-300">•</span>
                  <span className="shrink-0 flex items-center gap-1">
                    <span className="font-medium">{donor.itemsDonated}</span>{" "}
                    items
                  </span>
                  <span className="shrink-0 text-green-300">•</span>
                  <span className="flex items-center gap-1 shrink-0">
                    <TrendingUp className="w-3 h-3" />
                    <span className="font-medium">{donor.streak}</span> day
                    streak
                  </span>
                </div>
              </div>
              ...
              <div className="hidden md:block w-32 shrink-0">
                <div className="h-2 bg-green-100 rounded-full overflow-hidden">
                  <div
                    ...
                    style={{
                      width: `${
                        (donor.donations / dummyDonors[0].donations) * 100
                      }%`,
                    }}
                  />
                </div>
